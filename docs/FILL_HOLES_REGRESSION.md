...
2. Use a blind counterbore with a floor, bottom fillet, cylindrical wall,
   ...
   Face Hole Faces result, followed by the native Boss and Pocket Faces
   expansion from a cylindrical hole wall, to the preview. A floor or entry
...
8. If native hole recognition or expansion fails, verify the NX system log
...
10. On NX 2512, `CreateRuleFaceHole` must receive options from
...
11. On `test_model_2.prt`, native Delete Face cannot heal the tested holes even
