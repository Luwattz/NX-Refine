...
3. Review the single **Hole faces to fill** collector. Only pending faces are highlighted; the selected body is not highlighted as a whole. Deselecting any face excludes its entire hole group. Changing bodies or radius rebuilds the candidates; an unchanged delayed radius event preserves exclusions.
